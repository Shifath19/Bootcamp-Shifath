...
function HomePage() {
    ...
    const utils = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$trpc$2f$react$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].useContext();
    const { data: tasks, isLoading } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$trpc$2f$react$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].task.list.useQuery();
    const addTask = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$trpc$2f$react$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].task.add.useMutation({
        onSuccess: {
            "HomePage.useMutation[addTask]": ()=>{
                setNewTask("");
                setError("");
        ...
        onError: {
            "HomePage.useMutation[addTask]": (error)=>{
                setError(error.message);
            }
        }["HomePage.useMutation[addTask]"]
    });
    const deleteTask = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$trpc$2f$react$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].task.delete.useMutation({
        onSuccess: {
            "HomePage.useMutation[deleteTask]": ()=>{
                void utils.task.list.invalidate();
            }
        }["HomePage.useMutation[deleteTask]"]
    });
...
_s(HomePage, "jHrjkQsk+wSnu9iY3sq4x1jgaXk=");
_c = HomePage;
var _c;
